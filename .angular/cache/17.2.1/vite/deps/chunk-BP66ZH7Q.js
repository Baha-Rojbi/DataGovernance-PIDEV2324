...
var _MatError = class _MatError {
  constructor(ariaLive, elementRef) {
    this.id = "mat-mdc-error-".concat(nextUniqueId$2++);
    if (!ariaLive) {
...
var _MatHint = class _MatHint {
  constructor() {
    this.align = "start";
    this.id = "mat-mdc-hint-".concat(nextUniqueId$1++);
  }
};
...
var _MatFormField = class _MatFormField {
  ...
  constructor(_elementRef, _changeDetectorRef, _ngZone, _dir, _platform, _defaults, _animationMode, _unusedDocument) {
    ...
    this._labelId = "mat-mdc-form-field-label-".concat(nextUniqueId++);
    this._hintLabelId = "mat-mdc-hint-".concat(nextUniqueId++);
  ...
  _initializeControl() {
    ...
    if (control.controlType) {
      this._elementRef.nativeElement.classList.add("mat-mdc-form-field-type-".concat(control.controlType));
    }
...
//# sourceMappingURL=chunk-BP66ZH7Q.js.map
