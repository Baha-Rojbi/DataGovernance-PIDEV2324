...
import {
  ...
  _ErrorStateTracker,
  hasModifierKey
} from "./chunk-5BPZ6RLP.js";
import "./chunk-AGMJLHW4.js";
import {
  DOCUMENT
} from "./chunk-XGDTR5M7.js";
import {
...
var _MatChip = class _MatChip {
  ...
  constructor(_changeDetectorRef, _elementRef, _ngZone, _focusMonitor, _document, animationMode, _globalRippleOptions, tabIndex) {
    ...
    this.id = "mat-mdc-chip-".concat(uid++);
    this.ariaLabel = null;
    this.ariaDescription = null;
    this._ariaDescriptionId = "".concat(this.id, "-aria-description");
    this.removable = true;
    ...
    if (tabIndex != null) {
      this.tabIndex = (_a = parseInt(tabIndex)) != null ? _a : -1;
    }
    this._monitorFocus();
    (_b = this._rippleLoader) == null ? void 0 : _b.configureRipple(this._elementRef.nativeElement, {
...
var _MatChipOption = class _MatChipOption extends MatChip {
  constructor() {
    ...
    this._chipListHideSingleSelectionIndicator = (_b = (_a = this._defaultOptions) == null ? void 0 : _a.hideSingleSelectionIndicator) != null ? _b : false;
...
var _MatChipListbox = class _MatChipListbox extends MatChipSet {
  constructor() {
    ...
    this.required = false;
    this._hideSingleSelectionIndicator = (_b = (_a = this._defaultOptions) == null ? void 0 : _a.hideSingleSelectionIndicator) != null ? _b : false;
...
var _MatChipInput = class _MatChipInput {
  ...
  constructor(_elementRef, defaultOptions, formField) {
    ...
    this.placeholder = "";
    this.id = "mat-mdc-chip-list-input-".concat(nextUniqueId++);
    this._disabled = false;
