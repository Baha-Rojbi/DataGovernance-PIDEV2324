...
var _CdkDialogContainer = class _CdkDialogContainer extends BasePortalOutlet {
  ...
  _trapFocus() {
    ...
    switch (this._config.autoFocus) {
      ...
      case true:
      case "first-tabbable":
        (_a = this._focusTrap) == null ? void 0 : _a.focusInitialElementWhenReady().then((focusedSuccessfully) => {
...
var _MatDialog = class _MatDialog {
  ...
  open(componentOrTemplateRef, config) {
    ...
    config.id = config.id || "mat-mdc-dialog-".concat(uniqueId2++);
...
var _MatDialogTitle = class _MatDialogTitle extends MatDialogLayoutSection {
  constructor() {
    super(...arguments);
    this.id = "mat-mdc-dialog-title-".concat(dialogElementUid++);
  }
  _onAdd() {
    var _a, _b;
