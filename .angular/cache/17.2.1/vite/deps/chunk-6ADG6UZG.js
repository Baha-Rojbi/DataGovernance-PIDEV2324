...
function warnValidation(warnings) {
  (typeof ngDevMode === "undefined" || ngDevMode) && console.warn("animation validation warnings:".concat(createListOfWarnings(warnings)));
}
...
var TransitionAnimationEngine = class {
  ...
  removeNode(namespaceId, element, context) {
    var _a;
    if (isElementNode(element)) {
      (_a = this.scheduler) == null ? void 0 : _a.notify();
...
@angular/animations/fesm2022/browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6ADG6UZG.js.map
